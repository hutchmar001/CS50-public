...
def verse():
    ...
    if request.method == "POST":
        ...
        if bible_name and bible_chapter and bible_verse:
            ...
            return render_template('Bible.html', lst=lst, display1="visible", display2="none", display3="none", display_title="none",  search_upper="", search_lower="")
        ...
        if quran_sura and quran_verse:
            ...
            if not lst2:
                flash('Please enter a valid query.')
                return redirect("/verse")
            return render_template('Quran.html', lst2=lst2, display1="visible", display2="none", display3="none", display_title="none", display_select="none", display_img="none", display_hlight="visible", search_upper="", search_lower="")
        ...
        if quran_sura:
            ...
            if not lst2:
                flash('Please enter a valid query.')
                return redirect("/verse")
            return render_template('Quran.html', lst2=lst2, display_title="none", display_select="none", display_img="none", display_hlight="visible", search_upper="", search_lower="")
        ...
        if hindu_chapter and hindu_verse:
            ...
            if not lst3:
                flash('Please enter a valid query.')
                return redirect("/verse")
            return render_template('Bhagavad.html', lst3=lst3, display_title="none", display_select="none", display_img="none", display_hlight="visible", search_upper="", search_lower="")
